@extends('layouts.app') @section('content')
    ...
    <div class="well">
        ...
        @include('partials.textfield', ['label' => 'Team Name','name' => 'record','field' => 'team'])
        ...
        {{--@include('partials.textbox', ['label' => 'Mission Statement','name' => 'record','field' => 'method','assessment' => 'record'])--}}
